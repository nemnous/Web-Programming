...
window.onload = function display(){
    document.getElementById('image').innerHTML = '<img src="https://image.tmdb.org/t/p/w500'+mData.results[i].poster_path+'" class="img-responsive">'
    document.getElementById('votec').innerHTML = '<h1>'+mData.results[i].vote_average+'</h1>'
    document.getElementById('mTitle').innerHTML = '<h2>'+mData.results[i].title+'</h2>'
    document.getElementById('rDate').innerHTML = '<h4>'+mData.results[i].release_date+'</h4>'
    document.getElementById('mOverview').innerHTML = '<p>'+mData.results[i].overview+'<p>'
    document.getElementById('mInfo').innerHTML = '<a href="https://www.google.co.in/search?q='+mData.results[i].title+'">get more info</a>'
    hideButton('previous')
};
